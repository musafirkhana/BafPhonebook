...
public class MaintWingActivity extends Activity {
    ...
    public void MAINT2(View v) {
        ...
        Intent intent = new Intent(this, SearchListActivity.class);
        intent.putExtra("header", "MTR , "+getResources().getString(R.string.maint_1));
        startActivity(intent);
    ...
    public void MAINT3(View v) {
        ...
        Intent intent = new Intent(this, SearchListActivity.class);
        intent.putExtra("header", "MTR , "+getResources().getString(R.string.maint_2));
        startActivity(intent);
    ...
    public void MAINT4(View v) {
        ...
        Intent intent = new Intent(this, SearchListActivity.class);
        intent.putExtra("header", "MTR , "+getResources().getString(R.string.maint_3));
        startActivity(intent);
    ...
    public void MAINT5(View v) {
        ...
        Intent intent = new Intent(this, SearchListActivity.class);
        intent.putExtra("header", "MTR , "+getResources().getString(R.string.maint_4));
        startActivity(intent);
    ...
    public void MAINT6(View v) {
        ...
        Intent intent = new Intent(this, SearchListActivity.class);
        intent.putExtra("header", "MTR , "+getResources().getString(R.string.maint_5));
        startActivity(intent);
    ...
    public void MAINT7(View v) {
        ...
        Intent intent = new Intent(this, SearchListActivity.class);
        intent.putExtra("header", "MTR , "+getResources().getString(R.string.maint_6));
        startActivity(intent);
    ...
    public void MAINT8(View v) {
        ...
        Intent intent = new Intent(this, SearchListActivity.class);
        intent.putExtra("header", "MTR , "+getResources().getString(R.string.maint_7));
        startActivity(intent);
