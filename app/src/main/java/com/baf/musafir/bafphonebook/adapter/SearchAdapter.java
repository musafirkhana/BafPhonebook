...
public class SearchAdapter extends ArrayAdapter<PabxListModel> {
    ...
    public SearchAdapter(Context context) {
        super(context, R.layout.row_search, AllPabxListVector.getAllPabxlist());
    ...
    static class ViewHolder {
        ...
        private TextView txt_basename;
        private TextView txt_sqnname;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (v == null) {
            ...
            holder.txt_sqnname = (TextView) v.findViewById(R.id.txt_sqnname);
            holder.call_linear=(RelativeLayout)v.findViewById(R.id.row_call_linear);
