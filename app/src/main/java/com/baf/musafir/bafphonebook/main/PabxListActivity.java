...
public class PabxListActivity extends Activity {
    private Context mContext;
    private PabxAdapter pabxAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pabxlist);
        mContext = this;
    ...
    private void initUI() {
        ...
        pabxAdapter = new PabxAdapter(this);
